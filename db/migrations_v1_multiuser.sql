...
ALTER TABLE memories ADD COLUMN IF NOT EXISTS llm_optimized BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE memories ADD COLUMN IF NOT EXISTS optimized_at TIMESTAMPTZ;
