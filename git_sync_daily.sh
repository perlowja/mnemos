#!/bin/bash
# Daily sync of ARGONAS git repos → MNEMOS
# Stores recent commits as project activity memories

MNEMOS_API="http://localhost:5000"
REPOS=(
  '/mnt/argonas/backups/RiskyEats_Pipeline.git|RiskyEats|restaurant-inspections'
  '/mnt/argonas/backups/ETLANTIS_Pipeline.git|ETLANTIS|etl-engine'
  '/mnt/argonas/backups/MayaFerries.git|MayaFerries|ferries-routing'
)
...
log_message "Starting ARGONAS git sync to MNEMOS"
